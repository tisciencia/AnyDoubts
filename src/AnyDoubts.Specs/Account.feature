...
Scenario: Anonymous user can start creating an account
	...
	And  she should see a <form> containing a textfield: Username, textfield: Email, password: Password, password: 'Confirm Password', submit: 'Sign up'
...
Scenario: Anonymous user can create an account
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account as the preloaded 'firstuser'
	Then she should be redirected to the home page
	When she follows that redirect!
	Then she should see a notice message 'Thanks for signing up!'
    And a user with login: 'firstuser' should exist
    And the user should have login: 'firstuser', and email: 'firstuser@anydoubts.net'
    And firstuser should be logged in
...
Scenario: Anonymous user can not create an account with incomplete or incorrect input
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account with login: '',     password: 'monkey', password_confirmation: 'monkey' and email: 'firstuser@anydoubts.net'
	Then she should be at the 'users/new' page
    And she should     see an errorExplanation message 'Login can't be blank'
    And no user with login: 'firstuser' should exist
     
Scenario: Anonymous user can not create an account with no password
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account with login: 'firstuser', password: '',       password_confirmation: 'monkey' and email: 'firstuser@anydoubts.net'
	Then she should be at the 'users/new' page
...
Scenario: Anonymous user can not create an account with no password_confirmation
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account with login: 'firstuser', password: 'monkey', password_confirmation: ''       and email: 'firstuser@anydoubts.net'
	Then she should be at the 'users/new' page
...
Scenario: Anonymous user can not create an account with mismatched password & password_confirmation
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account with login: 'firstuser', password: 'monkey', password_confirmation: 'monkeY' and email: 'firstuser@anydoubts.net'
	Then she should be at the 'users/new' page
...
Scenario: Anonymous user can not create an account with bad email
	Given an anonymous user
    And no user with login: 'firstuser' exists
	When she registers an account with login: 'firstuser', password: 'monkey', password_confirmation: 'monkey' and email: ''
	Then she should be at the 'users/new' page
...
Scenario: Anonymous user can not create an account replacing an activated account
	Given an anonymous user
    And an activated user named 'Charlie'
    And we try hard to remember the user's updated_at, and created_at
	When she registers an account with login: 'charlie', password: 'monkey', and email: 'charlie@example.com'
	Then she should be at the 'users/new' page
    ...
    And a user with login: 'charlie' should exist
